...
public:
     ...
     */
    void set_token(const std::string& t) { secure_token_ = internal::to_secure_string(t); }
     ...
     */
    const internal::SecureString& get_secure_token() const { return secure_token_; }
     ...
     */
    bool has_secure_token() const { return !secure_token_.empty(); }
